              ...
              <table id="example1" class="table table-hover">
                ...
                <?php 
...

                  {
                      ...
                      $stmt = $conn->prepare (" SELECT * FROM airport");
                      ...
                      { ?>
                        ...
                        <tr>
                          ...
                          <td><?php $frequency_days= $object->airportname; ?>  
                          ...
                          ?>
                           ...
                           <td><a href='delete_airport.php?city_id=<?php print $object->city_id; ?>'>Delete</a></td>
...
<div id="myModal123" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
     ...
     <form action="db_airport_details.php" class="" method="post" >
             ...
             <div class="row"  style="padding:20px 40px;" >
                        ...
                        <div class="col-md-6">
                          ...
                          <div class="col-md-6"  style="padding:20px 40px;" >
                            <div class="row">
                            <label>Aiport Name</label> <input type="checkbox" name="check" id="checker">
                            
                            <div class="form-group">                       
                            <div id="hider">
                            <div class=""><input type="tel" name="aname[]" class="form-control" required><input type="checkbox" name="airportname[]">Require</div>
