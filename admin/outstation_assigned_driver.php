                      ...
                      try {
                        ...
                        <tr>
                          ...
                          <?php if($object->status=='Processing') { ?>
                            <a href="update_outstation_processing_status.php?status_id=<?php echo $object->id; ?>" onclick="return confirm('Are you sure for processing this ride')"><i class="fa fa-pencil-square-o"></i></a>&nbsp;&nbsp;
                            <?php } ?>
                            <a href="booking_delete.php?delete_outstation_assigned_id=<?php print $object->id; ?>" onclick="return confirm('Are you sure for deleting this ride')" class="delete"><i class="fa fa-trash-o "></i></a>
                          </td>
                          <!-- <td class="center">
