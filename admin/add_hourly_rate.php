      ...
      <section class="content">
        ...
        <div class="modal-body">
          ...
          <div class=row>
            <div class="col-md-6  pick-up">
              <label>Package</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <select name="package" class="form-control" required="required">
              <?php 
            ...
            <div class="col-md-6 pick-up">
              <label>Rate</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <input class="form-control" type="text" name="rate" placeholder="100" required="required" >
            </div>
          </div>
          <div class=row>
             <div class="col-md-6 pick-up">              
            ...
            <div class="col-md-6 pick-up">                            
              <input  type="submit" class="btn btn-primary update-button" name="add_hourly_rate" value="Add" style="margin-left: 0px;margin-top: 25px;">
