                    ...
                    <tbody>
                      ...
                      try {
                        ...
                        <tr>
                          ...
                          <td><?php print $object->pickup_address; ?></td>
                          ...
                          <td class="center">
                            ...
                            <a href="booking_delete.php?delete_hourly_assign_id=<?php print $object->id; ?>" title="<?php print $object->id; ?>" onclick="return confirm('Are you sure for deleting this ride')" class="delete"><i class="fa fa-trash-o "></i></a>
                          </td>
                        </tr>
                        <?php 
                      }
  ...
  <div id="myModal<?php print $object->id; ?>" class="modal fade" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <form action="update_hourly_booking_status.php" method="post">
