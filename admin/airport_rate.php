...
<body class="hold-transition skin-blue sidebar-mini">
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      <section class="content-header"><h1 style="float: left;margin-right: 10px">Rate Details</h1><a href="add_airport_rate.php"><button>Add New</button></a></section>
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped dataTable no-footer" cellspacing="0" width="100%">
                    <thead>
                      <tr>
                        <th>Taxi</th>
                        <th colspan="2">Intial km(To / From)</th>
                        <th colspan="2">Intial Rate(To / From)</th>
                        <th colspan="2">Standard Rate(To / From)</th>
                        <th>Time</th>
                        <th>Action</th>
                      </tr>
                    </thead>
                    <tbody>
                      <?php 
                      try {
                        $stmt = $conn->prepare (" SELECT * FROM airport_rates ");
                        $stmt -> execute();
                        ...
                        <tr>
                          ...
                          <td><?php print $object->tinitial_km; ?></td>
                          <td><?php print $object->finitial_km; ?></td>
                          <td><?php print $object->tinitial_rate; ?></td>
                          <td><?php print $object->finitial_rate; ?></td>
                          <td><?php print $object->tstandard_rate; ?></td>
                          <td><?php print $object->fstandard_rate; ?></td>
                          <td><?php print $object->timing; ?></td>                          
                          <td class="center">
                            <a href="update_airport_rate.php?id=<?php echo $object->id; ?>" ><i class="fa fa-pencil-square-o"></i></a>&nbsp;&nbsp;
                            <a href="taxi_package_delete.php?arr_id=<?php print $object->id; ?>"><i class="fa fa-trash-o " onclick="return confirm('Are you sure to delete')"></i></a>
                          </td>
                          <!-- <td class="center">
