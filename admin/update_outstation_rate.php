    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        ...
        <div class="modal-body">
          <div class=row>
            ...
            <div class="col-md-6 pick-up">
             ...
             <div class="col-md-6 pick-up">             
              ...
              <?php 
              $stmt1 = $conn->prepare ("SELECT * FROM outstation_rates WHERE id='".$_GET['id']."' ");
              $stmt1 -> execute();
              for($ii=0; $object1 = $stmt1->fetchObject(); $ii++)
                { ?> 
              <input class="form-control" type="text" name="initial_km" id="initial_km" placeholder="100" required="required" value="<?php echo $object1->initial_km; ?>">
            </div>
            <div class="col-md-6  pick-up" >
              <label id="initial">Initial Km Rate</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <input class="form-control" type="text" name="initial_rate" id="initial_km_rate" placeholder="49" required="required" value="<?php echo $object1->initial_rate; ?>">
            </div>
          </div>
          <div class=row>
            <div class="col-md-6 pick-up">
            ...
            <div class="col-md-6 pick-up">
              ...
              <input class="form-control" type="text" name="standard_rate" id="standard_rate" placeholder="100" required="required" value="<?php echo $object1->standard_rate; ?>">
            </div>
          ...
          <div class=row>            
          <div class="col-md-6 pick-up">
          <input  type="submit" class="btn btn-primary update-button pull-right" name="update_outstation_rate" value="Update" style="margin-left: 0px;margin-top: 25px;">
          </div>
            <div class="col-md-6 pick-up">
