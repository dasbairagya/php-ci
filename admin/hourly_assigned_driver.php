                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped dataTable no-footer" cellspacing="0" width="100%">
                    ...
                    <tbody>
                      <?php 
                      try {
                        $stmt = $conn->prepare (" SELECT * FROM hourly_rental where status !='booking'");
                        $stmt -> execute();
                        ...
                        <tr>
                          ...
                          <td><?php print $object->pickup_time; ?></td>
                          <td><?php print $object->pickup_date; ?></td>
                          <td><?php print $object->hour_package; ?></td>
                          <td><?php print $object->status; ?></td>
                          <td><?php print $object->driver_name; ?></td>
                          <td class="center">
                          <?php if($object->status=='Processing') { ?>
                            <a href="update_hourly_processing_status.php?status_id=<?php echo $object->id; ?>" onclick="return confirm('Are you sure for processing this ride')"><i class="fa fa-pencil-square-o"></i></a>&nbsp;&nbsp;
                            <?php } ?>
                            <a href="booking_delete.php?delete_hourly_assigned_id=<?php print $object->id; ?>" onclick="return confirm('Are you sure for deleting this ride')" class="delete"><i class="fa fa-trash-o "></i></a>
                          </td>
                          <!-- <td class="center">
