        ...
        <div class="modal-body">
          <div class=row>
            ...
            <div class="col-md-6  pick-up" >
              ...
              <input class="form-control" type="text" name="initial_km_rate" id="initial_km_rate" placeholder="49" required="required">
            </div>
          </div>
          <div class=row>
            <div class="col-md-6 pick-up">
          ...
          <div class=row>
            ...
            <div class="col-md-6 pick-up">                            
              <input  type="submit" class="btn btn-primary update-button" name="add_local_ride_rate" value="Add" style="margin-left: 0px;margin-top: 25px;">
