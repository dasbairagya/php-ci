...
<body class="hold-transition skin-blue sidebar-mini">
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      <section class="content-header"><h1 style="float: left;margin-right: 10px">Package Management</h1><a href="add_package.php"><button>Add New</button></a></section>
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped dataTable no-footer" cellspacing="0" width="100%">
                    ...
                    <tbody>
                      <?php 
                      try {
                        $stmt = $conn->prepare (" SELECT * FROM hourly_package ");
                        $stmt -> execute();
                        for($i=0; $object = $stmt->fetchObject(); $i++)
                          { ?>

                        <tr>
                          <td><?php print $object->hourly_package; ?></td>           
                          <td class="center">
                            <a href="update_package.php?id=<?php echo $object->id; ?>" ><i class="fa fa-pencil-square-o"></i></a>&nbsp;&nbsp;
                            <a href="taxi_package_delete.php?pk_id=<?php print $object->id; ?>" onclick="return confirm('Are you sure to delete')" class="delete"><i class="fa fa-trash-o "></i></a>
                          </td>
                          <!-- <td class="center">
