...
<body class="hold-transition skin-blue sidebar-mini">
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      <section class="content-header"><h1 style="float: left;margin-right: 10px">Rate Details</h1><a href="add_outstation_rate.php"><button>Add New</button></a></section>
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped dataTable no-footer" cellspacing="0" width="100%">
                    ...
                    <tbody>
                      <?php 
                      try {
                        $stmt = $conn->prepare (" SELECT * FROM outstation_rates");
                        $stmt -> execute();
                        for($i=0; $object = $stmt->fetchObject(); $i++)
                          { ?>

                        <tr>
                          <td><?php print $object->taxi; ?></td>
                          <td><?php if($object->trip_type==0){ print "One Way"; }else{ print "Two Way"; } ?></td>
                          <td><?php print $object->initial_km; ?></td>
                          <td><?php print $object->initial_rate; ?></td>
                          <td><?php print $object->standard_rate; ?></td>
                          <td><?php print $object->timing; ?></td>                          
                          <td class="center">
                            <a href="update_outstation_rate.php?id=<?php echo $object->id; ?>" ><i class="fa fa-pencil-square-o"></i></a>&nbsp;&nbsp;
                            <a href="taxi_package_delete.php?or_id=<?php print $object->id; ?>"><i class="fa fa-trash-o " onclick="return confirm('Are you sure to delete')"></i></a>
                          </td>
                          <!-- <td class="center">
