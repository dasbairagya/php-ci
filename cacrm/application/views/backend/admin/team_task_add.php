        ...
        <div class="panel panel-primary" data-collapsed="0">
            <div class="panel-heading">
                <div class="panel-title" >
                    ...
                    <?php echo get_phrase('assign_task_to_staff'); ?>
                </div>
            </div>
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                     <select name="task_id" class="selectboxit">
                            <option><?php echo get_phrase('select_a_task');?></option>
                            <?php
                            $add_task = $this->db->get('add_task')->result_array();
                           // var_dump($add_task);
                            foreach ($add_task as $row):
                                ?>
                ...
                <div class="form-group">
                    <div class="col-sm-offset-4 col-sm-7">
                        <button type="submit" class="btn btn-info" id="submit-button"><?php echo get_phrase('assign_task'); ?></button>
