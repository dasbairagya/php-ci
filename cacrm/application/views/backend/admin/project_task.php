...
<div class="col-md-7">
    ...
    <a href="#" class="btn btn-info pull-right tooltip-primary"
        ...
        <i class="entypo-plus"></i> <?php echo get_phrase('schedule_new_task');?>
    </a>
    <br><br><br>
            ...
            <div id="<?php echo $row2['project_task_id'];?>" class="panel-collapse collapse" style="height: auto;">
                ...
                <p style="font-size: 10px;">
                    ...
                    <a href="#" class="btn btn-default btn-xs tooltip-primary pull-right" data-toggle="tooltip"  data-placement="left" 
                        ...
                        onclick="confirm_modal('<?php echo base_url(); ?>index.php?admin/project_task/delete/<?php echo $row2['project_task_id']; ?>', '<?php echo base_url(); ?>index.php?admin/reload_projectroom_task/<?php echo $row['project_code']; ?>');">
...
<!--   display task-->
    <div class="panel panel-primary" data-collapsed="0">
        <div class="panel-heading">
            <div class="panel-title">
                <i class="fa fa-tasks"></i> <?php echo get_phrase('task');?>
            </div>
            <div class="panel-options">
            </div>
        </div>
