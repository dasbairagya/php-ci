    ...
    <header class="logo-env" >
        ...
        <div class="logo" style="">
            <a href="<?php echo base_url(); ?>">
                <img src="uploads/logo.png"  style="max-height:60px; width:100%;"/>
            </a>
        </div>
    ...
    <ul id="main-menu" class="">
            ...
            <ul>
                ...
                <li class="<?php if ($page_name == 'project_quote' || $page_name == 'project_quote_view') echo 'active';?>">
                    <a href="<?php echo base_url(); ?>index.php?admin/project_quote">
                        <i class="entypo-dot"></i>
                        <span><?php echo get_phrase('service_quote'); ?></span>
                    </a>
                </li>
                  
                 <li class="<?php if ($page_name == 'assignservice') echo 'active';?>">
                    <a href="<?php echo base_url(); ?>index.php?admin/assignservice">
                        <i class="entypo-dot"></i>
                        <span><?php echo get_phrase('add_service'); ?></span>
                    </a>
                </li>
            </ul>
        </li>
        ...
        <li class="<?php if ($page_name == 'team_task' ||
            ...
            <ul>
                ...
                <li class="<?php if ($page_name == 'add_task') echo 'active'; ?>">
                    <a href="<?php echo base_url(); ?>index.php?admin/add_task">
                        <i class="entypo-archive"></i>
                        <span><?php echo get_phrase('add_tasks'); ?></span>
                    </a>
                </li>
            </ul>
        </li>
      ...
      <!--   <li class="<?php if ($page_name == 'reminder') echo 'active';?>">
            <a href="<?php echo base_url(); ?>index.php?admin/reminder">
                <i class="entypo-calendar"></i>
        ...
        <li class="<?php if ($page_name == 'message') echo 'active';?>">
         ...
         <li class="<?php if ($page_name == 'remind') echo 'active';?>">
            <a href="<?php echo base_url(); ?>index.php?admin/remind">
                <i class="entypo-calendar"></i>
        ...
        <li class="<?php if ($page_name == 'document') echo 'active';?>">
            <a href="#">
                <i class="entypo-doc-text"></i>
                <span><?php echo get_phrase(' document'); ?></span>
            </a>
               <ul>
                <li class="<?php if ($page_name == 'view document') echo 'active';?>">
                    <a href="<?php echo base_url(); ?>index.php?admin/document">
                        <i class="entypo-dot"></i>
                        <span><?php echo get_phrase('view document'); ?></span>
                    </a>
                </li>
                <li class="<?php if ($page_name == 'required_document') echo 'active';?>">
                    <a href="<?php echo base_url(); ?>index.php?admin/required_document">
                        <i class="entypo-dot"></i>
                        <span><?php echo get_phrase('required_document'); ?></span>
                    </a>
                </li>
            </ul>
        </li>
        ...
        <li class="<?php if ($page_name == 'system_settings' ||
                                $page_name == 'manage_language' ||
                                    $page_name == 'email_settings' ||
                                        $page_name == 'payment_settings' || $page_name == 'smtp_email_settings')
                                            echo 'opened active has-sub';?>">
            <a href="#">
            ...
            <ul>
                ...
                <li class="<?php if ($page_name == 'smtp_email_settings') echo 'active';?>">
                    <a href="<?php echo base_url(); ?>index.php?admin/smtpemailsettings">
                        <i class="entypo-dot"></i>
...
<div class="pay"><a href="https://biz.traknpay.in/setmycompany" target="_blank">
		<h2 style="color:#ffffff; ">PAY NOW</h2>
		</a>
		</div>
</div>
