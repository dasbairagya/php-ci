    ...
    <div class="col-md-7">
        ...
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body">
                ...
                <?php echo form_open(base_url() . 'index.php?admin/project_message/add/' . $project_code, array(
    ...
    <?php echo form_close(); ?>
                ...
                foreach ($project_messages as $row2):
                    ...
                    <div class="alert alert-default" style="position:relative; padding:15px 15px 20px 15px;">
                        <strong>
                            <?php
                            echo $this->db->get_where($row2['user_type'], array(
        ...
        <?php if ($row2['message_file_name'] != ''): ?>
                            <span style="position:absolute; left:14px; bottom:2px; color:#A6A6A6; font-size:9px;">
                                <a href="<?php echo base_url(); ?>index.php?admin/project_message/download/<?php echo $row2['project_message_id']; ?>" 
...
<script>
                                ...
                                var post_refresh_url = '<?php echo base_url(); ?>index.php?admin/reload_projectroom_wall/<?php echo $project_code; ?>';
