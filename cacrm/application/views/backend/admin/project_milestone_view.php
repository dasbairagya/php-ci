...
<center>
    ...
    <div id="invoice_print">
        <table width="100%" border="0">
            <tr>
                <td width="50%"><img src="assets/images/logo.png" style="max-height:20px;"></td>
                <td align="right">
        ...
        <div class="alert alert-default">
            <strong><?php echo get_phrase('Service_name');?></strong> :

                  <?php $service_id =  $row['add_service_id'];
                     $where = "add_service_id = "."'".$service_id."'";
                     $this->db->where($where);
                     $service = $this->db->get('project_milestone')->row_array(); 
