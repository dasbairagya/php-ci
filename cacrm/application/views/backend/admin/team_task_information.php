...
<a href="javascript:;" onclick="showAjaxModal('<?php echo base_url();?>index.php?modal/popup/team_task_add/');" 
    class="btn btn-info btn-block">
        ...
        <?php
            ...
            if ($query->num_rows() > 0):
                ...
                foreach ($team_tasks as $row):
                   ...
                   $taskname  =   $this->db->get('add_task')->row_array(); 
        ...
        <a style="text-align: left;" href="<?php echo base_url();?>index.php?admin/team_task_view/<?php echo $row['team_task_id'];?>" 
            ...
            <i class="entypo-right-open"></i> <?php echo $taskname['task_title'];?>
        </a>
        <?php 
            endforeach;
                endif;
    ...
    <div class="panel panel-primary" data-collapsed="0">
        ...
        <div class="panel-heading">
            <div class="panel-title">
                ...
                <a href="#" class="pull-right tooltip-primary" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('delete_this_task');?>"
                    onclick="confirm_modal_hard_reload('<?php echo base_url();?>index.php?admin/team_task/delete/<?php echo $row['team_task_id'];?>');">
                    <i class="entypo-trash"></i>
                </a>
                <a href="#" class="pull-right tooltip-primary" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('edit_task');?>"
                    onclick="showAjaxModal('<?php echo base_url(); ?>index.php?modal/popup/team_task_edit/<?php echo $row['team_task_id']; ?>');">
        ...
        <div class="panel-body" style="padding:5px; background-color: #FFFCEE;">
            ...
            <?php echo form_open(base_url() . 'index.php?admin/save_task_note/' . $row['team_task_id'] , array('class' => 'task-note-save'));?>
...
<div class="col-md-3">
    ...
    <div class="alert alert-success">
        <?php echo get_phrase('running_task');?>
        <a href="<?php echo base_url();?>index.php?admin/team_task/mark_archived/<?php echo $row['team_task_id'];?>" 
            class="tooltip-primary pull-right" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('mark_as_archived');?>">
    ...
    <div class="panel panel-primary" data-collapsed="0">
        <div class="panel-heading">
            ...
            <?php if ($number_of_staffs > 0):?>
                <a href="#" class="btn btn-default tooltip-primary btn-xs" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('add_staff');?>"
                    onclick="showAjaxModal('<?php echo base_url(); ?>index.php?modal/popup/team_task_edit/<?php echo $row['team_task_id']; ?>');">
                        <i class="entypo-plus"></i>
                </a>
            <?php endif;?>
        ...
        if ($number_of_staffs < 1):
            ...
            <a href="#" onclick="showAjaxModal('<?php echo base_url(); ?>index.php?modal/popup/team_task_edit/<?php echo $row['team_task_id']; ?>');">
                <button class="btn btn-default btn-block" type="button">
                    <i class="entypo-plus"></i> <?php echo get_phrase('assign_staffs');?>
                </button>
            </a>
            ...
            <div class="panel-title" style="width:100%;">
                ...
                <?php if ($team_task_files->num_rows() > 0):?>
                    <a href="#" class="btn btn-default btn-xs pull-right tooltip-primary" data-toggle="tooltip"  data-placement="left"
                            ...
                            onclick="showAjaxModal('<?php echo base_url(); ?>index.php?modal/popup/team_task_file_add/<?php echo $row['team_task_id']; ?>');">
        ...
        <div class="panel-body" style="padding:0px;">
            ...
            <table class="table table-striped">
                    ...
                    ?>
                        <tr>
                            ...
                            <td style="padding: 8px 20px 0px 0px;">
                                <a href="<?php echo base_url(); ?>index.php?admin/team_task_file/download/<?php echo $row3['team_task_file_id']; ?>">
                            ...
                            <td align="right">
                                <a href="#"
                                    onclick="confirm_modal('<?php echo base_url(); ?>index.php?admin/team_task_file/delete/<?php echo $row3['team_task_file_id']; ?>', '<?php echo base_url(); ?>index.php?admin/reload_team_task_information_archived/<?php echo $row['team_task_id']; ?>');">
                    ...
                    <?php if ($team_task_files->num_rows() < 1):?>
                        <a href="#" onclick="showAjaxModal('<?php echo base_url(); ?>index.php?modal/popup/team_task_file_add/<?php echo $row['team_task_id']; ?>');">
...
<script>
    ...
    function show_response_on_task_note_save(responseText, statusText, xhr, $form) {
        ...
        reload_team_task_information('<?php echo base_url(); ?>index.php?admin/reload_team_task_information/<?php echo $team_task_id; ?>');


    }

    //reload the project page data after successfull update
    function reload_team_task_information(url)
    {
        $.ajax({
            url: url,
