...
<script type="text/javascript">
    ...
    {
    var calendar = $('#reminder_calendar');
...
$events = $this->db->get('calendar_reminder')->result_array();
    ...
    ?>
                        {
                                ...
                                allDay  :   true,
                                id      :   "<?php echo $row['calendar_reminder_id']; ?>",
...
<?php endforeach ?>
            ...
            date = $.fullCalendar.formatDate(date, "dd-MM-yyyy");
                    showAjaxModal('<?php echo base_url(); ?>index.php?modal/popup/calendar_reminder_add/' + date);
                    ...
                    var event_id = calEvent.id;
                            showAjaxModal('<?php echo base_url(); ?>index.php?modal/popup/calendar_reminder_edit/' + event_id);
                            //alert('Coordinates: ' + jsEvent.pageX + ',' + jsEvent.pageY);
                    ...
                    var $this = $(this),
                            ...
                            title: $this.text(),
                                    start: date,
                                    allDay: allDay,
                                    className: $this.data('reminder-class')
                            };
            ...
            $('.fc-reminder-inner').css('cursor', 'pointer');
