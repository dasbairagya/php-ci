    ...
    <div class="col-md-12">
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body">
                ...
                <?php echo form_open(base_url() . 'index.php?admin/reminder/create_reminder/' , array(
                'class' => 'form-horizontal form-groups-bordered validate calendar-reminder-add', 'enctype' => 'multipart/form-data')); ?>
                            ...
                            <option value="#128C48" data-iconurl="<?php echo base_url();?>uploads/green.png">
                                <?php echo get_phrase('green'); ?>
                                            ...
                                            <div class="radio radio-inline">
                                                <input type="radio" id="alldays" value="1" name="days"  >
                                                <label for="days">alldays</label>
                                            </div>

                <div class="form-group">
                    <div class="col-sm-offset-3 col-sm-7">
                        <button type="submit" class="btn btn-info" id="submit-button"><?php echo get_phrase('add_reminder'); ?></button>
...
$(document).ready(function() {
   ...
   //config for project task adding
    var options = {
        beforeSubmit: validate_calendar_reminder_add,
        success: show_response_calendar_reminder_add,
        resetForm: true
    };
    $('.calendar-reminder-add').submit(function () {
...
function validate_calendar_reminder_add(formData, jqForm, options) {
...
function show_response_calendar_reminder_add(responseText, statusText, xhr, $form)  {

    
    toastr.success("reminder added successfully", "Success");
