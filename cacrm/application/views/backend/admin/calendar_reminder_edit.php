<?php 
	$edit_data = $this->db->get_where('calendar_reminder' , array(
		'calendar_reminder_id' => $param2
	))->result_array();
?>
	    ...
	    <div class="col-md-12">
	        <div class="panel panel-primary" data-collapsed="0">
	            ...
	            <div class="panel-body">
	                ...
	                <?php echo form_open(base_url() . 'index.php?admin/reminder/edit/' . $param2 , array(
	                'class' => 'form-horizontal form-groups-bordered validate calendar-reminder-edit', 'enctype' => 'multipart/form-data')); ?>
...
<script>
    ...
    var post_refresh_url = '<?php echo base_url(); ?>index.php?admin/reload_event_reminder_body';
    var delete_event_url = '<?php echo base_url();?>index.php?admin/reminder/delete/<?php echo $param2;?>';
</script>
...
$(document).ready(function() {
   ...
   //config for project task adding
    var options = {
        beforeSubmit: validate_calendar_reminder_edit,
        success: show_response_calendar_reminder_edit,
        resetForm: true
    };
    $('.calendar-reminder-edit').submit(function () {
...
function validate_calendar_reminder_edit(formData, jqForm, options) {
...
function show_response_calendar_reminder_edit(responseText, statusText, xhr, $form)  {

    
    toastr.success("reminder updated successfully", "Success");
    $('#modal_ajax').modal('hide');
    reload_data(post_refresh_url);
}
