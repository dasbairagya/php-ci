...
<div class="mail-compose">
	...
	<?php echo form_open(base_url() . 'index.php?client/message/send_new/' , array(
		...
		<div class="form-group">
			...
			<br><br>
			<select class="form-control select2" name="receiver" id="receiver">
		...
		<div class="">
			<textarea class="form-control autogrow" rows="4" name="message" 
